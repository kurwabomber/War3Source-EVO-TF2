...
public printHelpInfo(client)
{
		...
		CPrintToChat(client,"{lightseagreen}Type {darkgreen}raceinfo{lightseagreen} to learn what different {darkgreen}skills {lightseagreen} each race gets!");
		...
		CPrintToChat(client,"{lightseagreen}Type {darkgreen}war3menu{lightseagreen} for the full help menu. Type {darkgreen}myinfo {lightseagreen} to see your current race info.");
}
