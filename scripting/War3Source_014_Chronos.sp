...
//leap
new Float:leapPower[]={500.0, 500.0, 500.0, 500.0, 500.0};
...
public Action OnW3TakeDmgAllPre(int victim, int attacker, float damage)
{
	...
	if(ValidPlayer(victim,false) && bTrapped[victim]){ ///trapped people can only be damaged with knife
